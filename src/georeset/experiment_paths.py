...
EXPERIMENT_GROUPS: dict[str, str] = {
    ...
    "article_text_classification_relevance_stratified_v1": (
        "006_relevance_stratified_evaluation"
    ),
...
def experiment_artifact_file(
    artifact_id: str, *parts: str, root: Path = EXPERIMENTS_ROOT
) -> Path:
