...
class DataPaths:
    ...
    article_evidence_highlights: str = "data/wiki/article_evidence_highlights.json"
    article_retrieved_evidence_windows: str = "data/wiki/article_retrieved_evidence_windows.json"
...
class ModelSettings:
    ...
    def from_env(cls) -> "ModelSettings":
        return cls(
            model_path=os.environ.get("GEORESET_WIKI_LANDCOVER_MODEL_PATH", cls.model_path),
            model_repo_id=os.environ.get("GEORESET_WIKI_LANDCOVER_MODEL_REPO_ID"),
        )
