...
from georeset_wiki_landcover.experiment_paths import experiment_artifact_file
from georeset_wiki_landcover.vision.clip_weak_labels import write_clip_label_splits
