...
from georeset_wiki_landcover.analysis.pageid_frames import load_optional_pageid_csv
from georeset_wiki_landcover.analysis.prediction_loading import load_annotated_prediction_records
from georeset_wiki_landcover.analysis.quality_subsets import quality_subset_masks
from georeset_wiki_landcover.analysis.shuffled_deltas import compute_shuffled_delta_rows
from georeset_wiki_landcover.classification.text_sources import shuffled_text_source_pairs
from georeset_wiki_landcover.experiment_paths import (
    experiment_artifact_dir,
    experiment_artifact_file,
)
from georeset_wiki_landcover.text.evidence_highlights import EVIDENCE_HIGHLIGHTS_VERSION
...
DEFAULT_QWEN_HIGHLIGHTS_EXPERIMENT_DIR = experiment_artifact_dir(
    "article_text_evidence_highlights_v1__qwen3_6_27b_q4_0"
)
DEFAULT_GEMMA_HIGHLIGHTS_EXPERIMENT_DIR = experiment_artifact_dir(
...
DEFAULT_QWEN_LANDUSE_EXPERIMENT_DIR = experiment_artifact_dir(
    "article_text_classification_landuse_evidence_v1__qwen3_6_27b_q4_0"
)
DEFAULT_GEMMA_LANDUSE_EXPERIMENT_DIR = experiment_artifact_dir(
    "article_text_classification_landuse_evidence_v1__gemma4_31b_it_q4_0"
)
DEFAULT_QWEN_EVIDENCE_CARD_EXPERIMENT_DIR = experiment_artifact_dir(
