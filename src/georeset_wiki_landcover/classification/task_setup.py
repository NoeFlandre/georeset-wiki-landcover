...
from georeset_wiki_landcover.classification.ground_truth import (
    build_corine_ground_truth,
    build_osm_ground_truth,
)
...
from georeset_wiki_landcover.classification.types import ClassificationTarget
