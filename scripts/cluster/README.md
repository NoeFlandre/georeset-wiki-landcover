...
- `submit_classification.sh`: syncs code/data, submits one classification OAR
  job, and exits unless `GEORESET_AUTO_SYNC=1`.
...
- `GEORESET_CLASSIFICATION_TASK`
- `GEORESET_CLASSIFICATION_TEXT_SOURCE`
- `GEORESET_CLASSIFICATION_OUTPUT_DIR`
- `GEORESET_MODEL_PATH`
- `GEORESET_MODEL_REPO_ID`
- `GEORESET_EXTRA_ARGS`
