...
The analysis is grounded in the generated `overview.csv`, `shuffled_delta.csv`, and per-run `*_metrics.json` files. The `summary_no_place` and `summary_no_place_shuffled` rows were rerun after deterministic title scrubbing was enforced for the no-place summary artifact. The LLM used for all experiments here is Qwen3.6-27B-Q4_0.gguf
...
| summary no place | 0.255 | 0.258 | 0.253 | 0.111 | +0.147 |
...
| summary no place | macro recall | 0.258 | 0.057 | +0.201 | 0.253 | 0.066 | +0.187 |
...
| summary no place | 0.255 | 0.258 | 0.253 |
...
| summary no place | 0.142 | 0.207 | -0.065 | 0.157 | 0.211 | -0.054 | 0.161 | 0.068 |
...
| summary no place | 0.142 | 0.065 | +0.076 | 0.157 | 0.075 | +0.081 | 0.068 | 0.040 | +0.028 |
